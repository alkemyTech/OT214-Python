...
#  Defining function to later sort the data by its amoun of AnswerCount.
...
def main_mapper_func(
    ...
    max_list = top_10_func(id_answers_clean)
    return max_list
...
def yielding_iterator():
    ...
    for item in top_10_max:
        ...
        num += 1
    file_logger.info(f' The top most answered posts are:\n{message}')
    console_logger.info(f' The top most answered posts are:\n{message}')
    return
